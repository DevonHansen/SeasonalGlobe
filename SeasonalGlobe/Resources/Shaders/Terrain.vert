...
uniform float uPercThroughSeason;
...
{	
   ...
   displacement = aDisScale * min(1.0, uPercThroughSeason);
   vec4 inPos = vec4(aVertex.x, aVertex.y + (displacement*0.005), aVertex.z, 1.0);
